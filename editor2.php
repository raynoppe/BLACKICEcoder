...
//-->
<script src="<?php echo $ICEcoder["codeMirrorDir"]; ?>/lib/codemirror.js?microtime=<?php echo microtime(true);?>"></script>
<?php
...
<div style="margin: 20px 43px 32px 43px; font-family: arial; font-size: 10px; color: #ddd;  background: #333">
	...
	<div style="float: left">
		...
		<?php echo $t['Using']?> <?php echo $ICEcoder['devMode'] ? "ice-coder.js" : "ice-coder.js";?> <a title="<?php echo $t['You can switch...'];?>" class="info">[?]</a>
	</div>
	<div style="clear: both"></div>
</div>
